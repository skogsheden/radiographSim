...
var EngineLoader = {
    ...
    wasmjs_size: 273892,
    wasm_pthread_sha1: "",
    wasm_pthread_size: 2618009,
    wasmjs_pthread_sha1: "",
    wasmjs_pthread_size: 262791,
    asmjs_sha1: "",
    asmjs_size: 5363748,
...
var Module = {
    ...
    engineSdkSha1: "0ad9c86fa0a9f7ac19bc468b1a67ee06bb2578b5",
    noInitialRun: true,
...
Module["locateFile"] = function(path, scriptDirectory)
{
    ...
    if (path == "dmengine.wasm" || path == "dmengine_release.wasm" || path == "dmengine_headless.wasm") {
        if (Module['isWASMPthreadSupported']) {
            path = "EDRImagesimulation_pthread.wasm";
        } else {
            path = "EDRImagesimulation.wasm";
        }
    }
